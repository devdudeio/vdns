...
export VDNS_GATEWAY_HOST=127.0.0.1
export VDNS_GATEWAY_PORT=80
...
export VDNS_TLS_TLD="${VDNS_TLS_TLD:-${VDNS_TLD:-vdns}}"
...
export VDNS_RESOLVER_URL="${VDNS_RESOLVER_URL:-http://127.0.0.1:${PORT:-8080}}"
